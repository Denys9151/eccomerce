        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                    <a href="{{ route('vendor.products-variant-item.index', ['productId' => $product->id, 'variantItemId' => $variant->id]) }}" class="btn btn-warning mb-4">Back </a>
                    <div class="dashboard_content mt-2 mt-md-0">
                        <h3><i class="far fa-user"></i>Crete Variant Item</h3>
