    ...
    <div class="card border">
        <div class="card-body">
            <form action="{{ route('admin.homepage-banner-section-three') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_one->banner_image) }}" width="150px">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_two->banner_image) }}" width="150px">
                </div>
                <div class="form-group">
                    <label>Banner Image</label>
