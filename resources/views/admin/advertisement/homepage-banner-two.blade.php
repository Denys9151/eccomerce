    ...
    <div class="card border">
        <div class="card-body">
            <form action="{{ route('admin.homepage-banner-section-two') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_two->banner_one->banner_image) }}" width="150px">
                </div>
                <div class="form-group">
                    <label>Banner Image</label>
                    <input type="file" class="form-control" name="banner_one_image" value="">
                    <input type="hidden" class="form-control" name="banner_one_old_image" value="{{ @$homepage_section_banner_two->banner_one->banner_image }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_two->banner_two->banner_image) }}" width="150px">
                </div>
                <div class="form-group">
                    <label>Banner Image</label>
                    <input type="file" class="form-control" name="banner_two_image" value="">
                    <input type="hidden" class="form-control" name="banner_two_old_image" value="{{ @$homepage_section_banner_two->banner_two->banner_image }}">
                </div>
                <div class="form-group">
                    <label>Banner url</label>
