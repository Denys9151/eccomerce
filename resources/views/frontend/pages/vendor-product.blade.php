        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                            <div class="wsus__vendor_text_center">
                                ...
                                <ul class="d-flex">
                                    ...
                                    <li><a class="instagram" href="{{ $vendor->inst_link }}"><i class="fab fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-12 col-lg-8">
                    <div class="row">
                        <div class="col-xl-12 d-none d-md-block mt-md-3 mt-lg-0">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <ul class="wsus__single_pro_icon">
                                                        ...
                                                        <form class="shopping-cart-form">
                                                            ...
                                                            @endforeach
                                                            <input name="qty" type="hidden" min="1" max="100" value="1"/>
                                                            <button type="submit" class="add_cart mr-2" href="#">add to cart</button>
                                                        </form>
                                                        <li><a href="" class="add-to-wishlist" data-id="{{ $product->id }}"><i class="far fa-heart"></i></a></li>
                                                        {{--                                                        <li><a href="#"><i class="far fa-random"></i></a>--}}
                                                    </ul>
