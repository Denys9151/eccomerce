                                    ...
                                    <ul class='exzoom_img_ul'>
                                        ...
                                        @foreach($product->productImageGalleries as $productImage)
                                            <li><img class="zoom ing-fluid w-100"
                                                     src="{{ asset($productImage->image) }}" alt="product"></li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="wsus__pro_details_text">
                            ...
                            <form class="shopping-cart-form">
                                ...
                                <ul class="wsus__button_area">
                                    ...
                                    <li><a style="border: 1px solid gray; padding: 7px 11px; border-radius: 100%;" href="javascript:;" class="add-to-wishlist" data-id="{{ $product->id }}"><i class="fal fa-heart"></i></a></li>
                                </ul>
                            </form>
                                                        ...
                                                        @foreach($reviews as $review)
                                                            <div class="wsus__main_comment">
                                                                ...
                                                                <div class="wsus__comment_text reply">
                                                                    ...
                                                                    <span>09 Jul 2021 {{ date('d M Y', strtotime($review->created_at)) }}</span>
                                                                    <p>{{ $review->review }}</p>
                                                                    <ul class="">
                                                                        @if(count($review->productReviewGalleries) > 0)
                                                                            @foreach($review->productReviewGalleries as $image)
                                                                                <li><img src="{{ asset($image->image) }}" alt="product" class="img-fluid"></li>
                                                                            @endforeach
                                                                        @endif
                                                                    </ul>
                                                                </div>
