                            ...
                            @if($settings->contact_email)
                                <div class="col-xl-12">
                                    <div class="wsus__contact_single">
                                        ...
                                        <h5>mail address</h5>
                                        <a href="{{ $settings->contact_email }}">{{ $settings->contact_email }}</a>
                            ...
                            @if($settings->contact_phone)
                                <div class="col-xl-12">
                                    <div class="wsus__contact_single">
                                        ...
                                        <h5>phone number</h5>
                                        <a href="{{ $settings->contact_phone }}">{{ $settings->contact_phone }}</a>
                ...
                $.ajax({
                    ...
                    success: function (data){
                        if(data.status === 'success'){
                            ...
                            $('#form-submit').attr('disable', false);
                        }
                    },
                    error: function (data){
