<header>
            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        <li><a href="{{ route('user.wishlist.index') }}"><i class="fal fa-heart"></i><span id="wishlist_count">{{ \App\Models\Wishlist::where('user_id', auth()->id())->count() }}</span></a></li>
    ...
    <div class="wsus__mini_cart">
        ...
        <ul class="mini_cart_wrapper">
            @foreach(\Gloudemans\Shoppingcart\Facades\Cart::content() as $sidebarProduct)
        ...
        <div class="mini_cart_actions {{\Gloudemans\Shoppingcart\Facades\Cart::content()->count() === 0 ? 'd-none' : ''}}">
