@php
    ...
    ->with(['subCategories' => function ($query) {$query->where('status', 1)->with(['childCategories' => function ($query) {
                ...
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        @foreach($categories as $category)
                            <li><a class="{{ count($category->subCategories) > 0 ? 'wsus__droap_arrow' : ''}}" href="#"><i
                            ...
                            <li>
                                <a href="#"
                                   ...
                                   aria-controls="flush-collapseThreew-{{ $loop->index }}">
                                    <i class="{{ $categoryItem->icon  }}"></i>{{ $categoryItem->name }}</a>
