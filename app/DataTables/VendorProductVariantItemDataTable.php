...
class VendorProductVariantItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $editBtn = "<a href='" . route('vendor.products-variant-item.edit', $query->id) . "' class='btn btn-primary'><i class='fa-regular fa-pen-to-square'></i></a>";
                $deleteBtn = "<a href='" . route('vendor.products-variant-item.destroy', $query->id) . "' class='btn btn-danger delete-item ml-2'><i class='fa-regular fa-trash-can'></i></a>";
    ...
    {
        return $model->where('product_variant_id', request()->variantItemId)->newQuery();
    }
