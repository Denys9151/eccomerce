    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $editBtn = "<a href='" . route('admin.footer-socials.edit', $query->id) . "' class='btn btn-primary'><i class='fa-regular fa-pen-to-square'></i></a>";
                $deleteBtn = "<a href='" . route('admin.footer-socials.destroy', $query->id) . "' class='btn btn-danger delete-item'><i class='fa-regular fa-trash-can'></i></a>";
