...
class HomeController extends Controller
{
    ...
    {
        $sliders = Slider::query()->where('status', 1)->orderBy('serial', 'asc')->get();
        ...
        $categoryProductSliderSectionOne = HomePageSetting::where('key', 'popular_slider_section_one')->first();
        $categoryProductSliderSectionTwo = HomePageSetting::where('key', 'popular_slider_section_two')->first();
        $categoryProductSliderSectionThree = HomePageSetting::where('key', 'popular_slider_section_three')->first();
