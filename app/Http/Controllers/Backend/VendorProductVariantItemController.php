...
class VendorProductVariantItemController extends Controller
{
    ...
    public function create(string $productId, string $variantItemId)
    {
        $product = Product::findOrFail($productId);
        $variant = ProductVariant::findOrFail($variantItemId);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.products-variant-item.index', ['productId' => $request->product_id, 'variantItemId' => $request->variant_id]);
    }
    ...
    public function update(Request $request, $variantItemId)
    {
        ...
        return redirect()->route('vendor.products-variant-item.index', ['productId' => $variantItem->productVariant->product_id, 'variantItemId' => $variantItem->product_variant_id]);
    }
