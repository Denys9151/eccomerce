...
class AdvertisementController extends Controller
{
    ...
    {
        $request->validate([
            'banner_one_image' => ['image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'banner_one_url' => ['required'],
            'banner_two_image' => ['image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
    ...
    public function homepageBannerSectionThree(Request $request)
    {
        $request->validate([
            ...
            'banner_two_image' => ['image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
            'banner_two_url' => ['required'],
            'banner_three_image' => ['image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
